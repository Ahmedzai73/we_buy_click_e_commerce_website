                        ...
                        >
                            <div className="w-32 h-32 flex-shrink-0 rounded-md overflow-hidden mr-4">
                                <Image
                                    ...
                                    src={item.product.image ? urlFor(item.product.image).url() : "/placeholder-image.png"}
                            ...
                            <div className="flex-grow">
                                ...
                                <p className="text-gray-600">Total: Rs.{((item.product.price ?? 0) * item.quantity).toFixed(0)}</p>
                            </div>
                        </div>
                        <div className="mt-4">
                            <AddToBasketButton
